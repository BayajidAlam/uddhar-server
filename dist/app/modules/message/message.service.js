...
const createMessage = (user, messageData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to create message!');
    }
});
...
const getSingleMessage = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'There is no message with the id/Failed to fetched message');
    }
});
const updateSingle = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to Update Message');
    }
    return result;
});
const deleteSingle = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (deleteMessage) {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'There is no message with the id/Failed to delete message');
    }
});
